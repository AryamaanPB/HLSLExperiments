...
void AAFluidSimulator::set_boundary(int N, int b, float* x)
{
...
void AAFluidSimulator::gauss_siedel(int N, int b, float* x, float* x0, float a, float c)
{
...
void AAFluidSimulator::diffuse(int N, int b, float* x, float* x0, float diff, float dt)
{
    float a = dt * diff * (N * N);
    gauss_siedel(N, b, x, x0, a, 1 + 4 * a);
}

void AAFluidSimulator::advect(int N, int b, float* d, float* d0, float* u, float* v, float dt)
{
...
void AAFluidSimulator::density_step(int N, float* x, float* x0, float* u, float* v, float diff, float dt)
{
...
void AAFluidSimulator::velocity_step(int N, float* u, float* v, float* u0, float* v0, float visc, float dt)
{
...
int AAFluidSimulator::IX(int i, int j, int N) {
    return ((i)+(N + 2) * (j));
}